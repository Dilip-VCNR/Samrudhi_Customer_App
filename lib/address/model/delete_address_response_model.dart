...
DeleteAddressResponseModel deleteAddressResponseModelFromJson(String str) =>
    DeleteAddressResponseModel.fromJson(json.decode(str));

String deleteAddressResponseModelToJson(DeleteAddressResponseModel data) =>
