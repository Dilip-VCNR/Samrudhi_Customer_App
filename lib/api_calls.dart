...
class ApiCalls {
  ...
  registerNewUser(String firstName, String lastName, String? latestUid, String email,
      String phone, String? fcmToken, String operatorCode, String operatorType,
      String storeReferralCode, String cableSubscriberId, String addressType,
      String completeAddress, String city, String state, double latitude,
      double longitude, String postalCode, File? selectedImage) async {
    ...
    if (selectedImage != null) {
      ...
      var multipartFile = http.MultipartFile('userImage', picStream, length, filename: selectedImage.path.split('/').last, contentType: MediaType('image', 'jpeg'),);
