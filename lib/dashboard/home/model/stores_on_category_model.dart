...
StoresOnSearchModel storesOnSearchModelFromJson(String str) => StoresOnSearchModel.fromJson(json.decode(str));

String storesOnSearchModelToJson(StoresOnSearchModel data) => json.encode(data.toJson());
...
class StoresOnSearchModel {
  ...
  factory StoresOnSearchModel.fromJson(Map<String, dynamic> json) => StoresOnSearchModel(
    status: json["status"],
