                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ListView.builder(
                        shrinkWrap: true,
                        itemCount:
                        dashboardProvider.homeData!.result!.nearStoresdata!.length,
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: ShapeDecoration(
                                    image: DecorationImage(
                                      image: dashboardProvider.homeData!.result!.nearStoresdata![index].storeImgArray!.isNotEmpty?NetworkImage(
                                          "${UrlConstant.imageBaseUrl}${dashboardProvider.homeData!.result!.nearStoresdata![index].storeImgArray![0].imageUrl}"):const NetworkImage(
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${dashboardProvider.homeData!.result!.nearStoresdata![index].displayName}',
                                      style: const TextStyle(
                                        color: Colors.black,
                                        fontSize: 16.55,
                                        fontWeight: FontWeight.bold,
                                    ...
                                    SizedBox(
                                      width: 212,
                                      child: Text(
                                        '${dashboardProvider.homeData!.result!.nearStoresdata![index].storeCategoryName}',
                                        style: const TextStyle(
                                          color: AppColors.fontColor,
                                          fontSize: 8,
                                          fontWeight: FontWeight.w500,
