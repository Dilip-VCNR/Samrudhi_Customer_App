...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder:
          (BuildContext context, WalletProvider walletProvider, Widget? child) {
        ...
        return Scaffold(
          body: walletProvider.walletResponse != null
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            '${walletProvider.walletResponse!.result!.redeemPointsDetails![index].redeempoint} points debited for',
                                            style: const TextStyle(
                                              color: AppColors.fontColor,
                                              fontSize: 14,
                                              fontWeight: FontWeight.w400,
